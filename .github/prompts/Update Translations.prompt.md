...
- English: [#file:custom_components/ha_asustor_nas_custom_integration/translations/en.json]
- German: [#file:custom_components/ha_asustor_nas_custom_integration/translations/de.json]
