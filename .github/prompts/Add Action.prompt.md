...
**File:** `custom_components/ha_asustor_nas_custom_integration/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: ha_asustor_nas_custom_integration
...
Create `custom_components/ha_asustor_nas_custom_integration/service_actions/[action_name].py`:

```python
"""[Action name] service action for Home Assistant Asustor NAS custom integration."""
...
**File:** `custom_components/ha_asustor_nas_custom_integration/__init__.py`
...
**File:** `custom_components/ha_asustor_nas_custom_integration/const.py`
...
3. Find service action: `ha_asustor_nas_custom_integration.[action_name]`
...
- **Service actions directory:** `custom_components/ha_asustor_nas_custom_integration/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/ha_asustor_nas_custom_integration/services.yaml` (legacy filename)
- **Icons:** `custom_components/ha_asustor_nas_custom_integration/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/ha_asustor_nas_custom_integration/translations/*.json` under `services` key (legacy)
