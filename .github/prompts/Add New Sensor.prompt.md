...
- Create new sensor file in `custom_components/ha_asustor_nas_custom_integration/sensor/`
- Inherit from `HomeAssistantAsustorNASCustomEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Home Assistant Asustor NAS custom integration."""
...
class HomeAssistantAsustorNASCustom[SensorName]Sensor(
...
- Entity: `custom_components/ha_asustor_nas_custom_integration/sensor/[sensor_name].py`
- Platform: `custom_components/ha_asustor_nas_custom_integration/sensor/__init__.py`
- Translations: `custom_components/ha_asustor_nas_custom_integration/translations/*.json`
