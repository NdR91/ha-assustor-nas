...
**Directory:** `custom_components/ha_asustor_nas_custom_integration/[platform]/`
...
```python
"""[Platform] platform for Home Assistant Asustor NAS custom integration."""
...
from .entity import HomeAssistantAsustorNASCustomEntity
from .[entity_file] import HomeAssistantAsustorNASCustom[EntityName]
from .const import DOMAIN
from .coordinator import HomeAssistantAsustorNASCustomDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: HomeAssistantAsustorNASCustomDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            HomeAssistantAsustorNASCustom[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Home Assistant Asustor NAS custom integration."""
...
class HomeAssistantAsustorNASCustom[EntityName](
    HomeAssistantAsustorNASCustomEntity,
    [PlatformEntityClass],
):
    ...
    def __init__(
        self,
        coordinator: HomeAssistantAsustorNASCustomDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/ha_asustor_nas_custom_integration/manifest.json`:
...
- [ ] Entity class inherits from both `HomeAssistantAsustorNASCustomEntity` and platform class
...
- **Base entity:** `HomeAssistantAsustorNASCustomEntity` in `entity/base.py`
- **Coordinator:** `HomeAssistantAsustorNASCustomDataUpdateCoordinator`
