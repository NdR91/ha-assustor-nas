...
- Inherit from `HomeAssistantAsustorNASCustomEntity` and platform base class
...
- Entity: `custom_components/ha_asustor_nas_custom_integration/[platform]/[entity_name].py`
- Platform: `custom_components/ha_asustor_nas_custom_integration/[platform]/__init__.py`
