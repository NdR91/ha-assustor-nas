...
- `entity/` — Base entity class (`HomeAssistantAsustorNASCustomEntity`)
...
- Entity MRO: `(PlatformEntity, HomeAssistantAsustorNASCustomEntity)` — order matters
...
- Debug level: `custom_components.ha_asustor_nas_custom_integration: debug` in `config/configuration.yaml`
