...
**Applies to:** `custom_components/ha_asustor_nas_custom_integration/manifest.json`
...
```json
{
  ...
  "name": "Home Assistant Asustor NAS custom integration",
  "codeowners": ["@NdR91"],
  "config_flow": true,
  "documentation": "https://github.com/NdR91/ha-assustor-nas",
  "integration_type": "device",
  "iot_class": "cloud_polling",
  "issue_tracker": "https://github.com/NdR91/ha-assustor-nas/issues",
  "requirements": [],
  "version": "0.0.0"
}
```
