...
- **`entity/`** - Base entity classes (inherit `HomeAssistantAsustorNASCustomEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, HomeAssistantAsustorNASCustomEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import HomeAssistantAsustorNASCustomEntity`
