...
**Applies to:** `custom_components/ha_asustor_nas_custom_integration/translations/*.json`
...
```json
{
  "config": {
    "error": {
      ...
      "stale_auth": "[%key:component::ha_asustor_nas_custom_integration::config::error::invalid_auth%]"
    }
  }
}
```
