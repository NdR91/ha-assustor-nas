...
- `HomeAssistantAsustorNASCustomApiClientError` (Base)
- `HomeAssistantAsustorNASCustomApiClientCommunicationError` (Network, timeout, HTTP errors)
- `HomeAssistantAsustorNASCustomApiClientAuthenticationError` (401, 403, invalid credentials)
