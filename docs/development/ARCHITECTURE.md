...
This document describes the technical architecture of the Home Assistant Asustor NAS custom integration custom component for Home Assistant.
...
│   ├── __init__.py          # Exports HomeAssistantAsustorNASCustomDataUpdateCoordinator
...
│   ├── __init__.py          # Exports HomeAssistantAsustorNASCustomEntity
...
- `base.py` - Main coordinator class (`HomeAssistantAsustorNASCustomDataUpdateCoordinator`)
...
**Key class:** `HomeAssistantAsustorNASCustomDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `HomeAssistantAsustorNASCustomApiClient`
...
- `HomeAssistantAsustorNASCustomConfigFlowHandler` (main flow)
- `HomeAssistantAsustorNASCustomOptionsFlow` (options)
...
**Key class:** `HomeAssistantAsustorNASCustomEntity` (in `entity/base.py`)
...
2. `HomeAssistantAsustorNASCustomEntity` for common functionality
...
1. Create directory: `custom_components/ha_asustor_nas_custom_integration/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `HomeAssistantAsustorNASCustomEntity`
