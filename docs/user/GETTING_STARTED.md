# Getting Started with Home Assistant Asustor NAS custom integration

This guide will help you install and set up the Home Assistant Asustor NAS custom integration custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/NdR91/ha-assustor-nas`
6. Set category to "Integration"
7. Click "Add"
8. Find "Home Assistant Asustor NAS custom integration" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/NdR91/ha-assustor-nas/releases)
2. Extract the `ha_asustor_nas_custom_integration` folder from the archive
3. Copy it to `custom_components/ha_asustor_nas_custom_integration/` in your Home Assistant configuration directory
...
3. Search for "Home Assistant Asustor NAS custom integration"
...
4. Select entities from "Home Assistant Asustor NAS custom integration"
...
logger:
  default: warning
  logs:
    custom_components.ha_asustor_nas_custom_integration: debug
```
...
- Report issues at [GitHub Issues](https://github.com/NdR91/ha-assustor-nas/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/NdR91/ha-assustor-nas/discussions)
